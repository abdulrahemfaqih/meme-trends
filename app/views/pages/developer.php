...
<body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
   ...
   <body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
      ...
      <!-- * section content -->
      <section class="pt-9 mb-20">
         <div class="container flex flex-col items-center justify-center">
            <div>
               <img src="../../../public/src/img/icon/myfoto.jpg" alt="profile" class="mx-auto my-6 animation-profile opacity-[10px] w-[70%] lg:w-[25%] rounded-lg shadow-2xl border dark:border-gray-700" />
            </div>
            <div>
               <h1 class="font-bold text-[28px] text-center animation-faded text-darkBlue dark:text-softBlue">
                  Abdul Rahem Faqih
               </h1>
            </div>
            <div class="]">
               <p class="py-6 mx-auto lg:w-[50%] text-center text-[16px] lg:text-[18px]">
                  Halo semua saya seorang mahasiswa teknik informatika yang
                  akhir akhir ini tertatrik di bidang fullstack web development
               </p>
            </div>
            <div class="flex flex-col items-center justify-center gap-y-2">
               <p class="text-lg font-semibold">Connect With Me</p>
               <div class="flex items-center gap-x-4">
                  <a href="">
                     <i class="ri-github-fill text-[20px] text-blue-900 dark:text-blue-500"></i>
                  </a>
                  <a href="">
                     <i class="ri-youtube-fill text-[20px] text-red-600"></i>
                  </a>
                  <a href="">
                     <i class="ri-instagram-fill text-[20px] text-pink-700"></i>
                  </a>
                  <a href="">
                     <i class="ri-tiktok-fill text-[20px]"></i>
                  </a>
               </div>
            </div>
         </div>
