...
<body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
   ...
   <section class="container">
      <!-- * header profile -->
      <div class="flex flex-col gap-y-2 justify-center items-center my-4 bg-white dark:bg-softDark/50 border-2 rounded-lg shadow-md dark:border-slate-800">
         <img src="../../../public/src/img/profile-user/profile.jpg" class="mx-auto border-2  dark:border-slate-800 rounded-full object-cover h-[170px] w-[170px] mt-6" alt="">
         <h1 class="font-normal text-2xl ">Abdul Rahem Faqih</h1>
         <div class="pb-4">
            <p class="text-gray-900 text-center text-sm dark:text-gray-500">@subhan</p>
            <div class="text-gray-900 dark:text-gray-500">
               <small>1000 pengikut</small>
               <small>|</small>
               <small>1 mengikuti</small>
               <small>| 1 Postingan</small>
            </div>
         </div>
      </div>
      <!-- * end header profile -->
      <!-- * postingan memes -->
      <div class=" flex flex-wrap justify-between pt-6 pb-24 gap-y-8">
         <!-- memes -->
         <div class="w-[385px] lg:w-[380px] h-[473px] border-2 bg-white dark:bg-dark  dark:border-slate-800 rounded-md shadow-md">
            <!-- header card -->
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-slate-800">
               <div class="flex items-center gap-2">
                  <img src="../../../public/src/img/profile-user/profile.jpg" alt="profile" width="35" height="35" class="rounded-full aspect-square" />
                  <div class="text-sm">
                     <h1 class="font-bold text-[16px]">Faqih</h1>
                     <p>8 jam yang lalu</p>
                  </div>
               </div>
               <button data-modal-target="modal-more-memes" data-modal-toggle="modal-more-memes" type="button">
            ...
            <!-- memes image -->
            <div style="
                     background-image: url(../../../public/src/img/memes/memes1.jpg);
                  " class="h-[280px] w-full bg-contain bg-no-repeat bg-center my-4">
            </div>
            <!-- end meme image -->
            <!-- caption -->
            <div class="px-6 py-2">
            ...
            <!-- end caption -->
            <!-- footer card -->
            <div class="flex items-center justify-between px-6 py-3 border-t dark:border-slate-800">
               <div class="flex items-center gap-4">
                  <div class="flex items-center gap-2">
                  ...
                  <div class="flex items-center gap-2">
                     <i class="ri-chat-4-line text-[22px]"></i>
                     <p>0</p>
                  </div>
               </div>
               <div>
                  <a href=""><i class="ri-share-fill text-[20px]"></i></a>
               </div>
            </div>
            <!-- end footer card -->
         </div>
