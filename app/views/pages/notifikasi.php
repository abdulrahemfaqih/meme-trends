...
<body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
   ...
   <section class="container py-6">
      <h1 class="px-6 py-4 border-y-2 border-x-2 font-medium rounded-t-lg bg-white dark:bg-dark  dark:border-slate-800">
         Notifikasi (2)</h1>
      <div class="py-4 px-6 border-l-2 border-r-2 border-b-2  dark:border-slate-800 bg-white dark:bg-dark">
         <div class="flex gap-x-2 items-center">
            <img src="../../../public/src/img/profile-user/foto 4 kali 6 bck biru.png" class="aspect-square h-[35px] w-[35px] rounded-full object-cover">
            <div class="flex items-center flex-wrap gap-x-2">
               <p class="font-semibold">Faqih</p>
               <p>Menyukai postingan anda.</p>
               <p class="text-[10px] text-gray-800 dark:text-gray-300"> ~ satu hari yang lalu</p>
            </div>
         </div>
      </div>
      <div class="py-4 px-6 border-l-2 border-r-2 border-b-2  dark:border-slate-800 bg-white dark:bg-dark">
