...
<body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
   ...
   <body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
      ...
      <!-- * section content -->
      <section class="container flex flex-wrap justify-between pt-6 pb-24 gap-y-8">
         <!-- card memes -->
         ...
         <div class="w-[385px] lg:w-[380px] h-[473px] border-2 bg-white dark:bg-dark dark:border-slate-800 rounded-md">
            <!-- header card -->
            <div class="flex items-center justify-between px-4 py-3 border-b dark:border-slate-800">
               <div class="flex items-center gap-2">
                  <img src="../../../public/src/img/profile-user/profile.jpg" alt="profile" width="35" height="35" class="rounded-full aspect-square" />
            ...
            <!-- memes image -->
            <div style="
                  background-image: url(../../../public/src/img/memes/memes2.jpg);
               " class="h-[280px] w-full bg-contain bg-no-repeat bg-center my-4">
            </div>
            <!-- end meme image -->
         ...
         <div class="w-[385px] lg:w-[380px] h-[473px] border-2 bg-white dark:bg-dark dark:border-slate-800 rounded-md">
            ...
            <!-- memes image -->
            <div style="
                  background-image: url(../../../public/src/img/memes/memes3.png);
               " class="h-[280px] w-full bg-contain bg-no-repeat bg-center my-4">
            </div>
            <!-- end meme image -->
