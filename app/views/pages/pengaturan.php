...
<body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
   ...
   <!-- * section content -->
   <section class="container max-w-screen-md py-10">
      <div>
         <h1 class="pb-6 font-semibold text-2xl text-center">Pengaturan Profile</h1>
      </div>
      <div class="flex flex-col gap-y-6">
         <!--edit profile -->
         <div>
            <h1 class="px-6 py-4 border-y-2 border-x-2 font-medium rounded-t-lg bg-white dark:bg-dark  dark:border-slate-800">Edit Profil</h1>
            <form action="" method="post">
               <div class="py-4 px-6 border-l-2 border-r-2 border-b-2 rounded-b-lg dark:border-slate-800 bg-white dark:bg-dark">
                  <div class="mb-6">
                     ...
                     <input type="text" id="nama" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="inputkan nama anda" required>
                  </div>
                  <div class="mb-6">
                     <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Foto
                        profil (jika perlu)</label>
                     <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-white/30 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file">
                  </div>
                  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                     Simpan perubahan
                  </button>
               </div>
            </form>
         ...
         <!-- edit nama pengguna -->
         <div>
            <h1 class="px-6 py-4 border-y-2 border-x-2 rounded-t-lg bg-white dark:bg-dark  dark:border-slate-800">Ganti
               Nama Pengguna</h1>
            <form action="" method="post">
               <div class="py-4 px-6 border-l-2 border-r-2 border-b-2 rounded-b-lg dark:border-slate-800 bg-white dark:bg-dark">
                  <div class="mb-6">
                     <label for="nama-2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                        Pengguna
                        Baru <span class="text-red-500">*</span></label>
                     <input type="text" id="nama-2" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="inputkan nama pengguna baru" required>
                  </div>
                  <div class="mb-6">
                     <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kata
                        Sandi
                        <span class="text-red-500">*</span></label>
                     <input type="password" id="password" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="inputkan kata sandi anda" required>
                  </div>
                  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                     Perbarui
                  </button>
         ...
         <div>
            ...
            <form action="" method="post">
               <div class="py-4 px-6 border-l-2 border-r-2 border-b-2 rounded-b-lg dark:border-slate-800 bg-white dark:bg-dark">
                  <div class="mb-6">
                     <label for="kataSandiSekarang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kata Sandi Saat Sini <span class="text-red-500">*</span></label>
                     <input type="password" id="kataSandiSekarang" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="inputkan kata sandi saat ini" required>
                  </div>
                  <div class="mb-6">
                     <label for="kataSandiBaru" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kata
                        Sandi Baru <span class="text-red-500">*</span></label>
                     <input type="password" id="KataSandiBaru" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="inputkan kata sandi baru anda" required>
                  </div>
                  <div class="mb-6">
                     <label for="konfirmasiKataSandiBaru" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Konfirasi Kata Sandi Baru
                        <span class="text-red-500">*</span></label>
                     <input type="password" id="konfirmasiKataSandiBaru" class="bg-white/30 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Konfirmasi kata sandi baru anda" required>
                  </div>
                  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                     Parbarui
                  </button>
         ...
         <!-- hapus akun -->
         <div>
            <h1 class="px-6 py-4 border-y-2 border-x-2 rounded-t-lg bg-white dark:bg-dark  dark:border-slate-800">Hapus
               Akun</h1>
            <div class="py-4 px-6 border-l-2 border-r-2 border-b-2 rounded-b-lg dark:border-slate-800 bg-white dark:bg-dark">
               <p class="pb-2 text-sm">Hapus Akun Secara permanen</p>
               <button data-modal-target="hapus-modal" data-modal-toggle="hapus-modal" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                  Hapus
               </button>
               <!-- * modal hapus akun -->
               <div id="hapus-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                  <div class="relative w-full max-w-md max-h-full">
                     <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="hapus-modal">
                        ...
                        <div class="p-6 text-center">
                           ...
                           <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah kamu yakin ingin menghapus akun secara permanen?</h3>
                           <form action="" method="post" class="inline">
                              <button data-modal-hide="popup-modal" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                 Iya, saya yakin
                              </button>
                           </form>
                           <button data-modal-hide="hapus-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                              Tidak</button>
                        </div>
                     </div>
                  </div>
