...
<body class="overflow-y-scrol bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
   <!doctype html>
   <html lang="en" class="scroll-smooth">
   ...
   <body class="overflow-y-scroll bg-coolWhite dark:bg-dark dark:text-slate-200 font-poppins scrollbar-thin scrollbar-thumb-cyan-800 custom-scrollbar">
      ...
      <section class="h-[70vh] flex justify-center items-center mb-12">
         <div class="container max-w-screen-md">
            <h1 class="pt-6 pb-3 text-center text-2xl font-bold">Masuk</h1>
            <div class="px-6 py-4 border-2 rounded-lg shadow-md dark:border-slate-800">
               <form method="post">
                  ...
                  <div class="pt-2 text-sm text-gray-900 dark:text-gray-400 font-medium">
                     belum punya akun? <a href="login.php" class="text-blue-500 hover:underline dark:text-blue-600">daftar disini</a>
                  </div>
               </form>
            </div>
         </div>
